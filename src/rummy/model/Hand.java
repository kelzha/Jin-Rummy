...
import rummy.model.Card.Rank;
import rummy.model.Card.Suit;
...
public class Hand implements Serializable
{
    ...
    public static void main(String[] args){
    	Hand test = new Hand();
    	test.add(new Card(Rank.ACE, Suit.CLUBS));
    	test.add(new Card(Rank.TWO, Suit.CLUBS));
    	test.add(new Card(Rank.THREE, Suit.CLUBS));
    	test.add(new Card(Rank.FOUR, Suit.CLUBS));
    	test.add(new Card(Rank.FIVE, Suit.CLUBS));
    	test.add(new Card(Rank.SIX, Suit.CLUBS));
    	test.add(new Card(Rank.SEVEN, Suit.CLUBS));
    	test.add(new Card(Rank.EIGHT, Suit.CLUBS));
    	test.add(new Card(Rank.EIGHT, Suit.DIAMONDS));
    	test.add(new Card(Rank.EIGHT, Suit.SPADES));
